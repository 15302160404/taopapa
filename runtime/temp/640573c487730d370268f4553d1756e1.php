<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\xampp\htdocs\taopapa\public/../application/admin\view\author\details.html";i:1529552361;s:56:"D:\xampp\htdocs\taopapa\application\admin\view\main.html";i:1529546873;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <ul class="ace-thumbnails">
                                        ...
                                        <li>
                                            <a href="#" data-rel="colorbox">
                                                <?php if($ar['logo'] == ''): ?>
                                                <img src="/taopapa/public/article/default.jpg" alt="<?php echo $ar['title']; ?>" height="150" width="150">
                                                <?php else: ?>
                                                <img alt="<?php echo $ar['title']; ?>" src="<?php echo $ar['logo']; ?>" height="150" width="150"/>
                                                <?php endif; ?>
												<div class="text">
													<div class="inner"><?php echo $ar['title']; ?></div>
												</div>
											</a>
                                            <div class="tools tools-bottom">
                                                <a href="javascript:void(0)" title="<?php echo $ar['author']['username']; ?>">
													<i class="icon-link"><span class="fa fa-user"></span></i>
												</a>
                                                <a href="#" title="<?php echo $ar['comment_num']; ?>">
													<i class="icon-paper-clip"><span class="fa fa-comment"></span></i>
												</a>
                                                <a href="#" title="88">
													<i class="icon-remove red"><span class="fa fa-eye"></span></i>
												</a>
                                            </div>
                                        </li>
