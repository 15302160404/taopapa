<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\xampp\htdocs\taopapa\public/../application/admin\view\author\details.html";i:1528343931;s:56:"D:\xampp\htdocs\taopapa\application\admin\view\main.html";i:1528343435;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="tab-content no-border padding-24">
                                ...
                                <div id="pictures" class="tab-pane">
                                    <ul class="ace-thumbnails">
                                        <?php if(is_array($model('article')->where('author_id',$author['id'])->select()) || $model('article')->where('author_id',$author['id'])->select() instanceof \think\Collection || $model('article')->where('author_id',$author['id'])->select() instanceof \think\Paginator): $i = 0; $__LIST__ = $model('article')->where('author_id',$author['id'])->select();if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                        <li>
                                            <a href="#" data-rel="colorbox">
												<img alt="150x150" src="<?php echo $vo['logo']; ?>" />
											     <div class="text">
												    <div class="inner"><?php echo $vo['title']; ?></div>
												</div>
											</a>
