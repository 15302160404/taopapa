<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\xampp\htdocs\taopapa\public/../application/admin\view\author\index.html";i:1528342187;s:56:"D:\xampp\htdocs\taopapa\application\admin\view\main.html";i:1528337622;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="index.html">管理作者</a>
			</li>
			<li>
				<a href="javascript:void(0)">作者列表</a>
			</li>
			<li>
				<a href="<?php echo url('author/index'); ?>">列表详情</a>
			</li>
		</ul><!-- /.breadcrumb -->
							...
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?php echo url('author/details',['username'=>$vo['username']]); ?>"><?php echo $vo['username']; ?></a>
										</td>
										<td><?php echo $vo['realname']; ?></td>
										<td class="hidden-480"><?php echo count(model('article')->where('author_id',$vo['id'])->select()); ?></td>
										<td><?php echo $vo['email']; ?></td>
										<td><?php echo $vo['tel']; ?></td>
										<td class="hidden-480">
											<span class="label label-sm label-success arrowed-in">
												<?php switch($vo['status']): case "0": ?>删除<?php break; case "1": ?>正常<?php break; case "2": ?>私有<?php break; case "3": ?>禁用<?php break; default: ?>状态不明
												<?php endswitch; ?>
											</span>
										</td>
										<td>
											<div class="hidden-sm hidden-xs btn-group">
												<button class="btn btn-xs btn-success" title="">
													<a href="<?php echo url('author/details',['username'=>$vo['username']]); ?>" class="ace-icon fa fa-search-plus bigger-120" style="color:#fff"></a>
												</button>
