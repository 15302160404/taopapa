            ...
            <div class="widget widget_sentence">
                ...
                <div class="widget-content">
                    <ul class="plinks ptags">
                        ...
                        <li>
                            <a href="#" title="<?php echo $vo['categoryname']; ?>" draggable="false"><?php echo $vo['categoryname']; ?> <span class="badge"><?php echo count(model('article')->where('category_id',$vo['id'])->select()); ?></span></a>
                        </li>
