<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\Bitnami\apache2\htdocs\taopapa\public/../application/index\view\article\detail.html";i:1529291170;s:66:"D:\Bitnami\apache2\htdocs\taopapa\application\index\view\base.html";i:1529045144;}*/ ?>
<!doctype html>
<html lang="zh-CN">
    ...
    <div class="content">
      <header class="article-header">
        ...
        <div class="article-meta">
          ...
          <?php if($article['author']['username']==session('username','','author')): ?><?php echo $name = "·我"; ?><?php echo $url = "author/index"; else: ?><?php echo $name = $article['author']['username']; ?><?php echo $url = "author/person"; endif; ?>
          <span class="item article-meta-category" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="作者：<?php echo session('username','','author'); ?>"><i class="glyphicon glyphicon-list"></i> <a href="<?php echo url($url,['username'=>$article['author']['username']]); ?>" title="作者：<?php echo $article['author']['username']; ?>" >作者：<?php echo $name; ?></a></span>
