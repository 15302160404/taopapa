<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\Bitnami\apache2\htdocs\taopapa\public/../application/index\view\login\index.html";i:1528555050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div id="forgot-box" class="forgot-box widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form action="<?php echo url('login/modifyPwd'); ?>" method="post">
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                            ...
                            <div id="signup-box" class="signup-box widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <div class="space-6"></div>
                                        <p> 输入详细信息: </p>
                                        <form action="<?php echo url('login/regist'); ?>" method="post">
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
